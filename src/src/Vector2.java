...
public class Vector2 implements Comparable, Serializable {
     ...
     * operation wraps the {@link subtract(Vector2, Vector2)} operation.
     ...
     * Vector2 object
     * @param is The java.io.ObjectInputStream to read from
    ...
    /**
     * Writes this Vector2 to an ObjectOutputStream
     * @param os The java.io.ObjectOutputStream to write to
     * @throws IOException 
     */
